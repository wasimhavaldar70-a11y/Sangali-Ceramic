...
export const metadata: Metadata = {
  title: 'Sangli Ceramica | Luxury Ceramic & Vitrified Tiles Website',
  description: 'Experience luxury living with Sangli Ceramica. Crafted for modern homes, high-end architects, and upscale commercial spaces. Explore marble, wood, and stone tiles.',
  metadataBase: new URL('https://sangliceramicapremiumtiles.vercel.app'),
  openGraph: {
    title: 'Sangli Ceramica | Luxury Ceramic & Vitrified Tiles',
