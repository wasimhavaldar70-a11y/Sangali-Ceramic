...
import { Users, Phone, Mail, BarChart3, ShieldAlert, Save } from 'lucide-react';
      ...
      <div className="space-y-4">
        {leads.length === 0 ? (
          <div className="text-center py-12 bg-dark-black/25 border border-white/5 rounded-lg">
            <p className="text-white/40">No lead submissions registered yet.</p>
          </div>
        ) : (
          leads.map(lead => (
            <motion.div
            ...
            >
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded text-[10px] uppercase font-bold tracking-widest border transition-colors shrink-0 ${
